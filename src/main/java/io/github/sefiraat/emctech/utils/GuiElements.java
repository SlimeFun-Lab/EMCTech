...
public final class GuiElements {
    ...
    public static final ItemStack TEMPLATE_BACKGROUND = CustomItemStack.create(
    ...
    public static final ItemStack TEMPLATE_INPUT_CARGO = CustomItemStack.create(
    ...
    public static final ItemStack TEMPLATE_INPUT_NO_CARGO = CustomItemStack.create(
        Material.BLUE_STAINED_GLASS_PANE,
        Theme.PASSIVE + "Input Slot",
        Theme.PASSIVE + "This slot is for items in.",
    ...
    public static final ItemStack TEMPLATE_OUTPUT_CARGO = CustomItemStack.create(
    ...
    public static final ItemStack TEMPLATE_OUTPUT_NO_CARGO = CustomItemStack.create(
        Material.ORANGE_STAINED_GLASS_PANE,
        Theme.PASSIVE + "Input Slot",
        Theme.PASSIVE + "This slot is for items in.",
    ...
    public static final ItemStack INFO_NOT_WORKING = CustomItemStack.create(
        Material.RED_STAINED_GLASS_PANE,
        Theme.PASSIVE + "Not Working",
        Theme.PASSIVE + "This machine is not currently working."
    );

    public static final ItemStack INFO_INVALID_ITEM = CustomItemStack.create(
        Material.ORANGE_STAINED_GLASS_PANE,
        Theme.PASSIVE + "Invalid Item",
        Theme.PASSIVE + "This item cannot be converted to/from EMC."
    );

    public static final ItemStack INFO_UNLEARNED_ITEM = CustomItemStack.create(
        Material.ORANGE_STAINED_GLASS_PANE,
        Theme.PASSIVE + "Unlearned Item",
        Theme.PASSIVE + "This item has not yet been learned."
    );

    public static final ItemStack INFO_PLAYER_OFFLINE = CustomItemStack.create(
        Material.ORANGE_STAINED_GLASS_PANE,
